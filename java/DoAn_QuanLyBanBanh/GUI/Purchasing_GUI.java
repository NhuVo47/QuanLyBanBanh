...
public class Purchasing_GUI extends javax.swing.JPanel {
    ...
    public Purchasing_GUI() {
        ...
        loadngay();
        loadDSSP();
        tableKhohang.getTableHeader().setBackground(new Color(255,153,0));
        tbSPnhap.getTableHeader().setBackground(new Color(255,153,0));
        tbctpn.getTableHeader().setBackground(new Color(255,153,0));
        tbdsPN.getTableHeader().setBackground(new Color(255,153,0));
    }
